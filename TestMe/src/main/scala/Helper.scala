...
object Helper {
  ...
  def cleanAndFlatten(spark:SparkSession, resourceCsvPath: String): DataFrame = {
  ...
  def enrichmentAddSecondFlag(spark: SparkSession, resourceCsvPath: String): DataFrame = {
